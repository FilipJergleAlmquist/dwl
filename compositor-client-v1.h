 ...
 * - @subpage page_iface_zinput_device_seat_mapper_v1 - a input device seat mapper that maps input devices to seats
 */
struct zcompositor_manager_v1;
struct zcompositor_v1;
struct zinput_device_seat_mapper_v1;
...
#endif
#ifndef ZINPUT_DEVICE_SEAT_MAPPER_V1_INTERFACE
#define ZINPUT_DEVICE_SEAT_MAPPER_V1_INTERFACE
/**
 * @page page_iface_zinput_device_seat_mapper_v1 zinput_device_seat_mapper_v1
 * @section page_iface_zinput_device_seat_mapper_v1_desc Description
 *
 * This object represents an input device mapper that can map input devices to a specific seat.
 * @section page_iface_zinput_device_seat_mapper_v1_api API
 * See @ref iface_zinput_device_seat_mapper_v1.
 */
/**
 * @defgroup iface_zinput_device_seat_mapper_v1 The zinput_device_seat_mapper_v1 interface
 *
 * This object represents an input device mapper that can map input devices to a specific seat.
 */
extern const struct wl_interface zinput_device_seat_mapper_v1_interface;
#endif
...
#define ZINPUT_DEVICE_SEAT_MAPPER_V1_REGISTER_INPUT_DEVICE 0
#define ZINPUT_DEVICE_SEAT_MAPPER_V1_DESTROY 1


/**
 * @ingroup iface_zinput_device_seat_mapper_v1
 */
#define ZINPUT_DEVICE_SEAT_MAPPER_V1_REGISTER_INPUT_DEVICE_SINCE_VERSION 1
/**
 * @ingroup iface_zinput_device_seat_mapper_v1
 */
#define ZINPUT_DEVICE_SEAT_MAPPER_V1_DESTROY_SINCE_VERSION 1

/** @ingroup iface_zinput_device_seat_mapper_v1 */
static inline void
zinput_device_seat_mapper_v1_set_user_data(struct zinput_device_seat_mapper_v1 *zinput_device_seat_mapper_v1, void *user_data)
{
	wl_proxy_set_user_data((struct wl_proxy *) zinput_device_seat_mapper_v1, user_data);
}

/** @ingroup iface_zinput_device_seat_mapper_v1 */
static inline void *
zinput_device_seat_mapper_v1_get_user_data(struct zinput_device_seat_mapper_v1 *zinput_device_seat_mapper_v1)
{
	return wl_proxy_get_user_data((struct wl_proxy *) zinput_device_seat_mapper_v1);
}

static inline uint32_t
zinput_device_seat_mapper_v1_get_version(struct zinput_device_seat_mapper_v1 *zinput_device_seat_mapper_v1)
{
	return wl_proxy_get_version((struct wl_proxy *) zinput_device_seat_mapper_v1);
}
 ...
 */
static inline void
zinput_device_seat_mapper_v1_register_input_device(struct zinput_device_seat_mapper_v1 *zinput_device_seat_mapper_v1, const char *name, int32_t seat_index)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zinput_device_seat_mapper_v1,
			 ZINPUT_DEVICE_SEAT_MAPPER_V1_REGISTER_INPUT_DEVICE, NULL, wl_proxy_get_version((struct wl_proxy *) zinput_device_seat_mapper_v1), 0, name, seat_index);
}
 ...
 */
static inline void
zinput_device_seat_mapper_v1_destroy(struct zinput_device_seat_mapper_v1 *zinput_device_seat_mapper_v1)
{
	wl_proxy_marshal_flags((struct wl_proxy *) zinput_device_seat_mapper_v1,
			 ZINPUT_DEVICE_SEAT_MAPPER_V1_DESTROY, NULL, wl_proxy_get_version((struct wl_proxy *) zinput_device_seat_mapper_v1), WL_MARSHAL_FLAG_DESTROY);
}
