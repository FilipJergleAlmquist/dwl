...
dwl.o: dwl.c config.mk config.h client.h xdg-shell-protocol.h wlr-layer-shell-unstable-v1-protocol.h compositor-unstable-v1-protocol.h compositor-unstable-v1-private-protocol.h
...
compositor-unstable-v1-private-protocol.h:
